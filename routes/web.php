...
Route::get('/tienda/promociones/editar', [TiendaController::class, 'editPromo'])->name('promociones.edit');

Route::get('/tienda/promociones/guardar', [TiendaController::class, 'updatePromo'])->name('promociones.update');
